  ...
  return (
    <div className="relative w-full max-w-md">
      <div className="flex space-x-2">
        ...
        <button
          onClick={handleAdd}
          className="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200 hover:cursor-pointer"
        >
          Add
        </button>
      </div>
      ...
      {suggestions.length > 0 && (
        <ul
          className="absolute z-10 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-300 rounded-md shadow-lg 
